...
#from chitanka_crawler_get_books_list import make_request
import chitanka_crawler_get_books_list
...
def main():
    c = chitanka_crawler_get_books_list.conn.cursor()
    ...
    for book in books:
        ...
        if download_book(str(book[0])):
            ...
            chitanka_crawler_get_books_list.conn.commit()
            new_books_count -= 1
                
    c.close()

if __name__ == '__main__':
    chitanka_crawler_get_books_list.init_make_request()
    main()